...
- (IBAction)startButton:(UIButton *)sender
{
    ...
    NSString *filePath = [NSString stringWithFormat:@"%@/vt_encode.h264", self.documentDictionary];
    _h264File = fopen([filePath UTF8String], "wb");
...
- (IBAction)stopButton:(UIButton *)sender
{
    ...
    fclose(_h264File);
    if (self.stopVideoData) {
        NSString *filePath = [NSString stringWithFormat:@"%@/vt_encode.h264", self.documentDictionary];
        self.stopVideoData(filePath);
    }
